...
public class ProduitDaoImpl implements IProduitDao { @Override
...
@Override
public List<Produit> produitsParMC(String mc) { List<Produit> prods= new ArrayList<Produit>(); Connection conn=SingletonConnection.getConnection(); try {
